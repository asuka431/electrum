...
WIF_HELP_TEXT = (_('WIF keys are typed in Electrum, based on script type.') + '\n\n' +
                 _('A few examples') + ':\n' +
                 'p2pkh:BxZcY47uGp9a...       \t-> DDckmggQM...\n' +
                 'p2wpkh-p2sh:BxZcY47uGp9a... \t-> 1NhNeZQXF...\n' +
                 'p2wpkh:BxZcY47uGp9a...      \t-> oc1q3fjfk...')
# note: full key is BxZcY47uGp9aVQAb6VVvuBs8SwHKgkSR2DbZUzjDzXf2N2GPhG9n
