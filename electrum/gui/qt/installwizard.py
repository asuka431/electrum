...
WIF_HELP_TEXT = (_('WIF keys are typed in Electrum, based on script type.') + '\n\n' +
                 _('A few examples') + ':\n' +
                 'p2pkh:RxZcY47uGp9a...       \t-> FDckmggQM...\n' +
                 'p2wpkh-p2sh:RxZcY47uGp9a... \t-> 7NhNeZQXF...\n' +
                 'p2wpkh:RxZcY47uGp9a...      \t-> fc1q3fjfk...')
# note: full key is RxZcY47uGp9aVQAb6VVvuBs8SwHKgkSR2DbZUzjDzXf2N2GPhG9n
