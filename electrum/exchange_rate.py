...
CCY_PRECISIONS = {'BTC': 8, 'ETH': 8, 'LTC': 7, 'BCH': 8, 'BNB': 6,
                  ...
                  'THB': 4, 'TRY': 5, 'TWD': 4, 'VEF': 0, 'VND': 1,
                  'ZAR': 4, 'XDR': 6, 'XAG': 7, 'XAU': 8, 'BIF': 3,
                  'BIF': 3, 'BYR': 3, 'CLF': 7, 'CVE': 3, 'DJF': 3,
                  'GNF': 3, 'IQD': 6, 'ISK': 3, 'JOD': 6, 'KMF': 3,
                  'LYD': 6, 'MGA': 4, 'MRO': 4, 'OMR': 6, 'PYG': 3,
                  'RWF': 3, 'TND': 6, 'UGX': 3, 'UYI': 3, 'VUV': 3,
                  'XAF': 3, 'XOF': 3, 'XPF': 3}
